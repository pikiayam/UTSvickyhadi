...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabLayout tabLayout1 = (TabLayout) findViewById(R.id.uts1);
        tabLayout1.addTab(tabLayout1.newTab().setText("Laman Resmi"));
        tabLayout1.addTab(tabLayout1.newTab().setText("Laman Internal"));
        tabLayout1.setTabGravity(TabLayout.GRAVITY_FILL);

        final ViewPager viewPager1 = (ViewPager) findViewById(R.id.viewpage1);
